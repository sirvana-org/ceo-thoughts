...
export default function PrivacyPolicy() {
    return (
        <main className={`${plusJakartaSans.className} min-h-screen bg-white w-full`}>
            <div className="w-screen md:max-w-4xl mx-auto px-6 py-12">
                <article className="prose prose-lg prose-gray max-w-none text-gray-800">
                    <h1 className="text-4xl font-bold mb-2 text-gray-900">Privacy Policy for Sirvana</h1>
                    <p className="text-sm text-gray-500 mb-8">Last updated: November 19, 2024</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Application</strong> refers to Sirvana, the software program provided by the Company.
                        </li>
                        <li>
                            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sirvana, Inc, 1420 Turk Street, Apartment PH2C, San Francisco, CA 94115.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: santiago@sirvana.com.ar</li>
                        <li>By phone number: 3435135169</li>
                    </ul>

                    <p className="text-xs text-gray-500 mt-10">Generated using Privacy Policies Generator</p>
                </article>
            </div>
        </main>
    );
